...
from ...logic.objects import PlantableSoil, Region, Entrance
...
class LostleafCavePlantTree(PlantableSoil):
    pass
...
regions = [
    ...
    LostleafCave.define(
        locations={
            ...
            LostleafCavePlantTree: carrying.apple
        },
        ...
        region_connections={
            Main: Any(
                ...
                carrying.jester_boots,
                event.Collected(
                    LostleafCavePlantTree) & item.double_jump & item.climb
            )
        }
    ),

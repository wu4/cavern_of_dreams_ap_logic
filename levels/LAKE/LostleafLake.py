...
from ...logic.objects import PlantableSoil, CarryableLocation
...
class BellTowerSoil(PlantableSoil):
    pass


class LakeMainAppleTree(CarryableLocation):
    carryable = "Apple"
